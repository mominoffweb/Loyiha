...
function Create({ active, setActive }) {
  ...
  return (
    <>
      <div className="btn but max-[375px]:h-[60px]   max-[375px]:w-64 max-[375px]: text-center  max-md:ml-[-14rem] rounded-[35px] text-white font-normal text-xl ">
        <button
          onClick={toggleModal}
        ...
        <div className="modal z-10 ">
          ...
          <form to="">
            <div className="modal-container ">
              ...
              <form className="flex-col flex gap-4 justify-center items-center">
                <label htmlFor="">
                  <input
